...
App.prototype.themeChange = function()
{
    ...
    var theme = {
        '#343434': ['dark', './css/dark.css?jjmm', './css/widget-dark.css?jjmm'],
        '#535353': ['dark', './css/dark.css?jjmm', './css/widget-dark.css?jjmm'],
        '#b8b8b8': ['gray', './css/gray.css?jj', './css/widget-gray.css?jj'],
        '#d6d6d6': ['gray', './css/gray.css?jj', './css/widget-gray.css?jj']
    };
